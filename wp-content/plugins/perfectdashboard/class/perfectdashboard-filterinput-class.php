...
class PerfectDashboardFilterInput
{
    /**
     * A container for PerfectDashboardFilterInput instances.
     *
     * @var array
     */
     ...
     * @param int   $xssAuto    Only auto clean essentials = 0, Allow clean blacklisted tags/attr = 1
     *
     * @return PerfectDashboardFilterInput The PerfectDashboardFilterInput object
     */
    ...
    protected function _decode($source)
    {
        ...
        // Convert decimal
        $source = preg_replace_callback('/&#(\d+);/m', array($this, '_helper_convert_decimal'), $source);

        // Convert hex
        $source = preg_replace_callback('/&#x([a-f0-9]+);/mi', array($this, '_helper_convert_hex'), $source);

        return $source;
    }

    public function _helper_convert_decimal($m)
    {
        return utf8_encode(chr($m[1]));
    }

    public function _helper_convert_hex($m)
    {
